...
describe("PATCH /api/v1/activations/:token_id", () => {
  describe("Anonymous User", () => {
    test("With nonexistent activation token", async () => {
      const response = await fetch(
        "http://localhost:3030/api/v1/activations/145b3da2-12d2-4c2f-b3ee-d6bf82060352",
        {
          method: "PATCH",
        },
      );
    ...
    test("With expired activation token", async () => {
      ...
      const response = await fetch(
        `http://localhost:3030/api/v1/activations/${expiredActivationToken.id}`,
        {
          method: "PATCH",
        },
      );
    ...
    test("With already used token", async () => {
      ...
      const response1 = await fetch(
        `http://localhost:3030/api/v1/activations/${activationToken.id}`,
        {
          method: "PATCH",
        },
      );
  ...
  describe("Default User", () => {
    test("With valid token, but already logged in user", async () => {
      ...
      const response = await fetch(
        `http://localhost:3030/api/v1/activations/${user2ActivationToken}`,
        {
          method: "PATCH",
          headers: {
